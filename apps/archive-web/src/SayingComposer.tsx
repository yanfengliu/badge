...
import { SAYING_GRAPHEME_LIMIT, countSayingGraphemes, type ArchiveLifecycle } from "@badge/archive-domain";
      ...
      <div className="saying-interactions" aria-busy={proposal.status === "requesting"}>
        {!isEarned && editing ? (
          <div className="saying-editor">
            ...
            >
              {manualError ?? `${graphemeCount} of ${SAYING_GRAPHEME_LIMIT} graphemes.`}
            </p>
