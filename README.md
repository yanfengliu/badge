...
The repository is currently in its documentation-first phase; application code has not been scaffolded yet.

## Product direction

- One local user in the first version, with no account or server required.
- Git-tracked application code, achievement catalogues, computed-goal rules, and art recipes.
...
Future implementation work must begin with [AGENTS.md](AGENTS.md) and the linked local policy.
