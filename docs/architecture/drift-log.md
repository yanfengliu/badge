...
Record structural changes between the documented architecture and the implemented repository newest first.
...
| 2026-08-22 | No implementation exists; the architecture is a target rather than a description of code. | First scaffold must either implement D-007 or append a superseding decision and update `ARCHITECTURE.md`. |
