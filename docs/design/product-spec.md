...
- Archive keyboard access covers gallery navigation, local-definition draft navigation and authoring-request export, 3D rotation, zoom, light adjustment, reset, quotation regeneration and disclosure, activation, and archive backup or restore.
