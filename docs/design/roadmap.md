...
- Revisit earned badges in a read-only memory timeline ordered by real-world occurrence dates, distinguish occurrence time from the later activation timestamp, and reopen the exact pinned memory without introducing repeat-occurrence authoring.
