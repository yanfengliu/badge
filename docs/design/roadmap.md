...
- Generate new compact-paragraph proposals targeting one to three sentences or select an exact source-checked historical quotation, try another without losing the accepted saying, explicitly accept a proposal, and author or replace the text directly.
